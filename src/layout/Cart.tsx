...
export default function Cart() {
  ...
  return (
    <div>
      ...
      {cart.length === 0 ? (
        <p className="p-4 bg-[var(--color-surface)] rounded-md shadow-sm  text-[var(--color-text-secondary)] text-center">Your cart is empty...</p>
      ) : (
        <div className="overflow-y-auto max-h-[500px] items-center ">
          {cart.map((item) => (
            <div
              key={item.id}
              className="flex items-center justify-between p-4 mb-3 bg-[var(--color-bg-alt)] rounded-md shadow-sm "
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-2 py-1 rounded-md bg-[var(--color-bg)] text-[var(--color-text-primary)]"
                >
                  -
                </button>
          ...
          <p className="p-4 bg-[var(--color-bg)] rounded-md shadow-sm  text-[var(--color-text-primary)] font-semibold ">
